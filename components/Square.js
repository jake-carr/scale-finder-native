...
class Square extends React.Component {
    ...
    assignID = () => {
        if (this.props.highlightAllRoots === true && this.props.note === this.props.scale[0]) {
            this.setState({id: styles.highlight});
        } else if (this.props.note === this.props.scale[0]) {
            this.setState({id: styles.root});
        } else if (this.props.scale.includes(this.props.note)) {
