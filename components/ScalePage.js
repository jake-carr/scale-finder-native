...
import { createScale, convertNoteToString } from "../utils.js";
    ...
    return (
      <View style={this.state.styles.page}>
        <View style={this.state.styles.buttonContainer}>
          ...
          <TouchableOpacity
            style={this.state.styles.toggleButton}
            onPress={this.toggle}
          >
        ...
        <View style={this.state.styles.header}>
          <Text style={this.state.styles.headerText}>
            <Text style={this.state.styles.rootText}>
              {convertNoteToString(this.state.preference[rootIndex])}
            </Text>
            {"  " + name}
          </Text>
        </View>
